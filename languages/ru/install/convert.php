...
$languages = array(
    ...
    'convert_notice' => 'Спасибо за установку CTRev! Сейчас Вам будет предоставлена возможность
    ...
    'convert_groups_compare_notice' => '<b>*Инструкция:</b> укажите соответствие между
        ...
        разделяйте их символом <b>"|"</b>.<br>
        Для <b>ВСЕХ</b> групп из Вашей БД далее <b>должно</b> быть установлено соответствие с какой-либо группой из CTRev!'
);
?>