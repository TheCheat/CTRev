...
<html>
    <head>
        ...
        <link rel="stylesheet" href="[*$atheme_path*]css/style.css"
              type="text/css">
        <link rel="stylesheet" href="[*$theme_path*]css/admin_dependence.css"
              type="text/css">
                    ...
                    <div class="right_shadow">
                        <div class="body_div">
                            <div id="top-menu" class="transperent-container">
                                <a href="index.php" class="top_home_image">
                                    <img src="[*$atheme_path*]images/home.png"
                                ...
                                <ul class="tabs-nav">
                                    [*foreach from=$imods key='item' item='null'*]
                                        <li [*if $item==$selected_item*] class="tabs-selected"[*/if*]>
                                            <a href="[*$eadmin_file|uamp*]&amp;item=[*$item*]"><span>[*"top_menu_`$item`_item"|lang*]</span></a>
                                        </li>
                                    [*/foreach*]
                                </ul>
