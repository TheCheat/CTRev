...
[*if 'system'|perm*]
    <div class='hidden' id='action_popup_change_group'><b>[*'usearch_group'|lang*]:</b>&nbsp;[*select_groups*]</div>
[*/if*]
<div class='hidden' id='action_popup_delete_content'>
    <dl class='info_text'>                
        <dt>[*'usearch_choose_content_to_delete'|lang*]</dt>
        <dd><input type='checkbox' name='content[content]' value='1'>&nbsp;[*'usearch_content_content'|lang*]<br>
