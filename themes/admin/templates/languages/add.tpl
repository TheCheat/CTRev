...
<script type='text/javascript'>
    ...
    function change_langfield(obj) {
        ...
        if (!big) {
            ...
            w.empty().append('<'+'input type="text" name="'+name+'" value="'+val+'" size="50">');
    }
    function add_langfield() {
        ...
        jQuery('div.langfield_input', li).empty().append('<'+'input type="text" name="values[]" size="50">');
        obj.append(li);
    }
        ...
        <fieldset>
                            ...
                            <div class='padding_left'>
                                ...
                                <a href="javascript:void(0);" onclick="remove_langfield(this);"
                                   class='remove_lang_catfield[*if !$was*] hidden[*/if*]'>
                                    <img src="[*$atheme_path*]engine_images/delete.png" title="[*'delete'|lang*]"
                                         alt="[*'delete'|lang*]"></a>
                                &nbsp;&nbsp;&bull;&nbsp;&nbsp;
                            ...
                            <dl class='info_text'>
                                ...
                                <dd><div class='clear_both'>
                                        <div class='langfield_input'>
                                            <input type='text' name='values[[*$key*]]'  value='[*$value|he:false:true|rnl*]' size='50'>
                                        </div>
                                        <div class='lang_buttons'>
                                            <a href='javascript:void(0);' onclick='change_langfield(this);'>
                                                <img src="[*$atheme_path*]engine_images/arrow_inout.png" 
            ...
            <div align='center'>
                ...
                <a href="javascript:add_langfield_cat();">
                    <img src="[*$atheme_path*]engine_images/cat_add.png" align='right'
