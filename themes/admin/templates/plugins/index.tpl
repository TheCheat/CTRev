...
<div align="right" class='padding_right'>
    ...
    [*if $pluginselector*]
        ...
        <a href="javascript:plugin_act('add', jQuery('select[name=plugin_files]').val());">
            <img src="[*$atheme_path*]engine_images/add_small.png" title="[*'add'|lang*]" alt="[*'add'|lang*]">
        </a>
