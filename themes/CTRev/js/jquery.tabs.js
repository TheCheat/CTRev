 ...
 */
    $.fn.tabs = function(initial, settings) {
        ...
        return this.each(function() {
            ...
            // prepare remote tabs
            if (settings.remote) {
                if (settings.remoteClass)
                    container = jQuery("div."+settings.remoteClass);
                tabs.each(function() {
                ...
                var _setAutoHeight = function(reset) {
                    ...
                    var heights = $.map(containers.get(), function(el) {
                        ...
                        if (reset) {
                            ...
                            h = jq.css({
                                'min-height': ''
                            }).height(); // use jQuery's height() to get hidden element values
                        } else {
            ...
            tabs.bind('triggerTab', function() {
                ...
                if (container.locked || (!settings.saveLinks && li.is('.' + settings.selectedClass)) || li.is('.' + settings.disabledClass)) {
                    return false;
                }
            ...
            tabs.bind('click', function(e) {
                ...
                if (container['locked'] || (li.is('.' + settings.selectedClass) && !settings.saveLinks) || li.is('.' + settings.disabledClass) || typeof onClick == 'function' && onClick(this, toShow[0], toHide[0]) === false) {
                    this.blur();
                    return false;
                }
