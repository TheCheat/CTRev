    ...
    jQuery.fn.lavaLamp = function(o) {
        ...
        return this.each(function() {
            ...
            if (o.homeTop || o.homeLeft) {
                var $home = jQuery('<'+o.target+' class="homeLava"></'+o.target+'>').css({
                    left:o.homeLeft,
                    top:o.homeTop,
                    width:o.homeWidth,
                    height:o.homeHeight,
            ...
            if ($selected.length<1) {
                ...
                $lt.each(function(){
                    var thishref = $('a',this).first().attr('href');
                ...
                if (pathmatch_len>0) {
                    //console.log('found match:'+$('a',$pathel).first().attr('href'));
                    $selected = $pathel;
                }
            //else
            ...
            $back = jQuery('<div class="backLava"><div class="leftLava"><div class="rightLava"><div class="centerLava"></div></div></div></div>').css('position','absolute').prependTo(this);
