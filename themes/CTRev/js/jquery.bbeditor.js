 ...
 * Я уже сам не помню, сколько выпил в тот день, когда это писал.
 * Good luck, comrads!
 */

/**
 * Вставка цитаты в Textarea
 * @param arr array массив из объектов textarea и iframe(wysiwyg)
 * @param author string автор цитаты
 * @param txt string текст цитаты
 * @return null
 */
 ...
 * @param name string ID формы с бб-кодами
 * @return null
 */
 ...
 * @param $st object объект textarea
 * @param code string BBCode(img, url, f.e.)
 * @param html bool HTML?
 * @return null
 */
function url_bbcode($st, code, html) {
    ...
    if ($text.match(URL_PATTERN)) {
        ...
        //    $text = "[baseurl]"+$text.substr(baseurl.length);
    ...
    //    $url = "[baseurl]"+$url.substr(baseurl.length);
    var $pos = "";
    if (code=="img") {
 ...
 * @param $st object объект textarea
 * @param code string BBCode(list, nlist, f.e.)
 * @param html bool HTML?
 * @return null
 */
 ...
 * @param $sel_text string выбранный текст
 * @param code string тип BBCode(регэкспом)
 * @param subcode string имя BBCode(center, left, right, f.e.)
 ...
 * @param o object объект
 * @return object область
 */
function getRange(o) {
    var r;
    if (o.getSelection) {
 ...
 * @param o object объект
 * @param html bool HTML?
 * @param text bool получение текста?
 * @return string текст
 */
 ...
 * @param o object объект
 * @param what string чем заменяем
 * @param code string BBCode
 * @param subparam string параметр BBCode
 * @param html bool HTML?
 * @return null
 */
 ...
 * @param o object объект
 * @param what string что вставляем
 * @param html bool HTML?
 * @param code string BBCode
 * @return null
 */
 ...
 * @param obj object объект textarea
 * @return string ID textarea
 */
 ...
 * @param name string ID или name textarea
 ...
 * Выборка iframe
 * @param name string ID textarea
 * @param jq bool без jQuery
 * @param wind bool окно?
 ...
 * @param o object объект textarea
 ...
 * @param name string|object ID или объект textarea
 * @param wysiwyg bool WYSIWYG?
 * @param nols bool без загрузки?
 * @return null
 */
 ...
 * @param rgb_in string исходный цвет в RGB
 * @return int цвет в HEX
 */
...
/**
 * Замена " и ' в паттерне
 * @param patt string паттерн
 * @return string обработанный паттерн
 */
 ...
 * @param patt object паттерн
 * @param encoded bool HTML?
 * @param not_global bool без модификатора "g"
 * @return object обработанный паттерн
 */
 ...
 * @param text string исходный текст
 * @param h2b bool HTML->BBCode?
 * @param not_encodes bool не экранировать?
 * @return string обработанный текст
 */
