...
src="[*$theme_path*]/js/jquery.jCal.animate.js"></script>
<script type="text/javascript" src="[*$theme_path*]/js/jquery.jCal.js"></script>
<script type="text/javascript">
    var $torrents_per_dates = [*$torrents_count*];
    function init_date () {
        ...
        $('#block_calendar').jCal({
            ...
            changeMY:		function (days, jCalData) {
                ...
                jQuery.post("[*$baseurl|sl*]index.php?module=ajax_index&from_ajax=1&act=calendar_torrents", {"year":days.getFullYear(), "month":days.getMonth()+1}, function (data) {
                    ...
                    $torrents_per_dates = new Array ();
                    jQuery('#calendar_loader').hide();
                });
                return true;
            },
            callback:		function (date) {
                var $link = '[*gen_link module="torrents" year="\$1" month="\$2" day="\$3" slashes=true*]';
            ...
            dCheck:			function (day) {
                ...
                if (day.getFullYear()==$curdate.getFullYear() && day.getMonth()==$curdate.getMonth() && day.getDate()==$curdate.getDate())
                    ...
                    $ret = 'weekend';
                if ($torrents_per_dates[day.getDate()]) {
                    return new Array("<"+"span title=\""+$torrents_per_dates[day.getDate()]+" [*'calendar_torrents_added_at_day'|lang|sl*]\""+">", $ret+" torrents_in_day", "<"+"/span"+">");
                } else {
                    return $ret;
                }
                //	return 'invday';
