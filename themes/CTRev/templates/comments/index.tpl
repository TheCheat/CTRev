                                    ...
                                    <div class="author">[*$trow.username|gcl:$trow.group*], 
                                        ...
                                        [*if  check_owner($trow.poster_id, 'edit_comm') || check_owner($trow.poster_id, 'del_comm') || ($trow.type == 'users' && $trow.toid == 'id'|user) || 'comment'|perm:2*]
                                            <span id="comment_[*$trow.id*]_buttons" class="hidden">&nbsp;&nbsp;&nbsp;&nbsp;[
                                                [*if 'comment'|perm:2*]
                                                    <a href="javascript:quote_comment('[*$trow.username|sl*]', [*$trow.id*], '[*if $title4comments*][*gen_link 
module=$trow.type id=$trow.toid title=$title4comments cid=$trow.id*][*/if*]');">
                                ...
                                <div class="body">
                                    ...
                                    [*if $trow.signature*]
                                        <div class='br'></div>
                                        <hr class='gray_border2' style="width: 200px; text-align: left;">
                                        [*$trow.signature|ft*]
                                    [*/if*]
                                </div>
                            </div>
