    ...
    <div class='cornerText gray_color2'>
        <fieldset>
            ...
            <dl class='info_text'>
                ...
                <dd><input type='text' name='color' id='group_color' value='[*$row.color*]' size='35'>                    
                    <div class="group_colorpicker">
                        <a href="javascript:void(0);" onclick="toggle_menu(this, true);">
                            <img src="[*$theme_path*]engine_images/view.png" 
                ...
                <dd>[*simple_selector name='acp_modules' values=$allowed_modules current=$row.acp_modules size=5 empty=true*]</dd>
                ...
                <dt>[*'groups_area_torrents_count'|lang*]</dt>
                <dd><input type='text' name='torrents_count' value='[*$row.torrents_count*]' size='10'></dd>
