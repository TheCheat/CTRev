        ...
        <fieldset><legend>[*'search_addin_params'|lang*]</legend>
            <dl class="info_text">
                ...
                <dd><select name='status'>
                        ...
                        <option value='unchecked'>[*'torrents_status_unchecked'|lang*]</option>
                        [*foreach from=$statuses item='null' key='status'*]
                            <option value='[*$status*]'>[*"torrents_status_$status"|lang*]</option>
                        [*/foreach*]
                    </select>
                </dd>
                <dt>[*'search_category'|lang*]</dt>
                <dd>
                    [*select_categories*]<br>
                </dd>
                ...
                <dd>[*'search_from'|lang*]&nbsp;&nbsp;[*select_date name="from"*]<br>
                    [*'search_to'|lang*]&nbsp;&nbsp;[*select_date name="to"*]</dd>
