<script type='text/javascript'>
    ...
    scrtext = function(ronly) {
        return (!ronly ? "[*'content_torrent_screenshot_n'|lang|sl*]" + scnum : "")
...
<dl class='info_text screenshots'>
    ...
    [*foreach from=$nrow.screenshots item="i" key="n"*]
        <dt>[*if !$p*][*'content_torrent_poster'|lang*][*else*][*'content_torrent_screenshot_n'|lang*][*$p*][*/if*]</dt>
        <dd class='iposter'>
            [*if 'allowed_screenshots'|config == ($smarty.const.ALLOWED_IMG_PC | $smarty.const.ALLOWED_IMG_URL)*]
                <a href='javascript:void(0);' onclick='scr_type(this, 1)'>[*'content_torrent_from_server'|lang*]</a>&nbsp;|&nbsp;<a
                    href='javascript:void(0);' onclick='scr_type(this, 0)'>[*'content_torrent_from_pc'|lang*]</a>
                <div class='br'></div>
            [*/if*]
            <input 
