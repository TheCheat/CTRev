...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content) {
        ...
        if (count($this->_plugin_info)) {
            ...
            $_plugins_params .= '))';
            $plugins_code = "<?php include_once(SMARTY_CORE_DIR . 'core.load_plugins.php');\nsmarty_core_load_plugins($_plugins_params, \$this); ?>\n";
        ...
        if ($this->_init_smarty_vars) {
            $template_header .= "<?php include_once(SMARTY_CORE_DIR . 'core.assign_smarty_interface.php');\nsmarty_core_assign_smarty_interface(null, \$this); ?>\n";
    ...
    function _compile_insert_tag($tag_args) {
        ...
        return "<?php include_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');\necho smarty_core_run_insert_handler($_params, \$this); ?>" . $this->_additional_newline;
    }
    ...
    function _compile_include_php_tag($tag_args) {
        ...
        return "<?php include_once(SMARTY_CORE_DIR . 'core.smarty_include_php.php');\nsmarty_core_smarty_include_php($_params, \$this); ?>" . $this->_additional_newline;
    }
    ...
    function _compile_section_start($tag_args) {
        ...
        foreach ($attrs as $attr_name => $attr_value) {
            switch ($attr_name) {
                ...
                case 'max' :
                case 'start' :
                    $output .= "{$section_props}['$attr_name'] = (float)$attr_value;\n";
                    break;

                case 'step' :
                    $output .= "{$section_props}['$attr_name'] = floatval($attr_value) == 0 ? 1 : (float)$attr_value;\n";
                    break;
            ...
            foreach ($_indexes as $_index) {
                if (substr($_index, 0, 1) == '[') {
                    ...
                    if (substr($_index, 2, 2) == '__') {
                        $this->_syntax_error('call to internal object users is not allowed', E_USER_ERROR, __FILE__, __LINE__);
